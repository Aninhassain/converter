...
const TemperatureInterval = () => {
  ...
  const [fromUnit, setFromUnit] = useState<string>('kelvin');
  const [toUnit, setToUnit] = useState<string>('celsius');

  const units = [
    { value: 'kelvin', label: 'Kelvin [K]', factor: 1 },
    { value: 'celsius', label: 'Celsius degree [°C]', factor: 1 },
    { value: 'fahrenheit', label: 'Fahrenheit degree [°F]', factor: 1.8 },
    { value: 'rankine', label: 'Rankine [°R]', factor: 1.8 }
  ];
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-6">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-3xl font-bold text-gray-900">Temperature Interval Converter</h1>
            </div>
