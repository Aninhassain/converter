...
const MassFluxDensity = () => {
  ...
  const [fromUnit, setFromUnit] = useState<string>('kilogram-per-square-meter-second');
  const [toUnit, setToUnit] = useState<string>('gram-per-square-centimeter-second');

  const units = [
    { value: 'kilogram-per-square-meter-second', label: 'kg/(m²·s)', factor: 1 },
    { value: 'gram-per-square-centimeter-second', label: 'g/(cm²·s)', factor: 10 },
    { value: 'pound-per-square-foot-second', label: 'lb/(ft²·s)', factor: 0.204816 }
  ];
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-6">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-3xl font-bold text-gray-900">Mass Flux Density Converter</h1>
            </div>
