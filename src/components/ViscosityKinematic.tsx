...
const ViscosityKinematic = () => {
  ...
  const [fromUnit, setFromUnit] = useState<string>('square-meter/second');
  const [toUnit, setToUnit] = useState<string>('stokes');

  // Kinematic viscosity units with conversion factors (relative to square-meter/second)
  const viscosityUnits = useMemo(() => [
    { name: 'square-meter/second', symbol: 'm²/s', factor: 1 },
    { name: 'stokes', symbol: 'St', factor: 0.0001 },
    { name: 'centistokes', symbol: 'cSt', factor: 0.000001 },
    { name: 'square-foot/second', symbol: 'ft²/s', factor: 0.092903 },
    { name: 'square-millimeter/second', symbol: 'mm²/s', factor: 0.000001 },
    { name: 'square-centimeter/second', symbol: 'cm²/s', factor: 0.0001 },
    { name: 'square-inch/second', symbol: 'in²/s', factor: 0.00064516 },
    { name: 'square-meter/hour', symbol: 'm²/h', factor: 2.777778e-4 },
    { name: 'square-foot/hour', symbol: 'ft²/h', factor: 2.58064e-5 },
  ...
  const sortedViscosityUnits = useMemo(() => {
    const commonUnits = ['square-meter/second', 'stokes', 'centistokes'];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold text-gray-900">Kinematic Viscosity Converter</h1>
            </div>
            <p className="text-lg text-gray-600">
              Convert between different kinematic viscosity units
            </p>
          </div>
          ...
          {/* Common Conversions */}
          <div className="mt-8">
            <h3 className="text-xl font-semibold text-gray-800 mb-4 text-center">Common Kinematic Viscosity Conversions</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <h4 className="font-medium text-gray-700 mb-2">Square Meter/Second to Stokes</h4>
                <p className="text-sm text-gray-600">1 m²/s = 10000 St</p>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <h4 className="font-medium text-gray-700 mb-2">Stokes to Centistokes</h4>
                <p className="text-sm text-gray-600">1 St = 100 cSt</p>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <h4 className="font-medium text-gray-700 mb-2">Square Meter/Second to Centistokes</h4>
                <p className="text-sm text-gray-600">1 m²/s = 1000000 cSt</p>
              </div>
            </div>
          </div>
        </div>
