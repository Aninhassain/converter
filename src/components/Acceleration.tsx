...
const Acceleration = () => {
  ...
  const defaultFromUnit = 'meter-per-second-squared';
  const defaultToUnit = 'g-force';
  ...
  const units = [
    { value: 'meter-per-second-squared', label: 'Meter/second² [m/s²]', factor: 1 },
    { value: 'g-force', label: 'G-force [g]', factor: 9.80665 },
    { value: 'foot-per-second-squared', label: 'Foot/second² [ft/s²]', factor: 0.3048 },
    { value: 'kilometer-per-second-squared', label: 'Kilometer/second² [km/s²]', factor: 1000 }
  ];
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-6">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-3xl font-bold text-gray-900">Acceleration Converter</h1>
            </div>
