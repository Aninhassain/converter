...
const HeatFluxDensity = () => {
  ...
  const defaultFromUnit = 'watt-per-square-meter';
  const defaultToUnit = 'calorie-per-second-square-centimeter';
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow p-6">
            ...
            <div className="text-center mt-4">
              <button onClick={handleReset} className="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded-full inline-flex items-center transition-colors">
