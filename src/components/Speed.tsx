...
const Speed = () => {
  ...
  const [toUnit, setToUnit] = useState<string>('kilometer-per-hour');

  const units = [
    { value: 'meter-per-second', label: 'Meter/second [m/s]', factor: 1 },
    { value: 'kilometer-per-hour', label: 'Kilometer/hour [km/h]', factor: 0.277778 },
    { value: 'mile-per-hour', label: 'Mile/hour [mph]', factor: 0.44704 },
    { value: 'knot', label: 'Knot [kn]', factor: 0.51444 },
    { value: 'foot-per-second', label: 'Foot/second [ft/s]', factor: 0.3048 }
  ];
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-6">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-3xl font-bold text-gray-900">Speed Converter</h1>
            </div>
