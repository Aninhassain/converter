...
const MagneticFluxDensity = () => {
  ...
  const [fromUnit, setFromUnit] = useState<string>('tesla');
  const [toUnit, setToUnit] = useState<string>('gauss');

  // 1 tesla = 10000 gauss
  const units = [
    { value: 'tesla', label: 'Tesla [T]', factor: 1 },
    { value: 'gauss', label: 'Gauss [G]', factor: 1/10000 }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-slate-100 py-8">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-6">
            <div className="flex items-center justify-center gap-3 mb-4">
              <Gauge className="h-8 w-8 text-cyan-600" />
              <h1 className="text-3xl font-bold text-gray-900">Magnetic Flux Density Converter</h1>
            </div>
